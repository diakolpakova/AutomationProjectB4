...
import io.loop.test.pages.LoopPracticeDynamicLoading1;
...
public class T1_dynamic_loading1 {
    ...
    public void dynamic_loading_1() {
        ...
        assertTrue(BrowserUtils.waitForVisibility(loopPracticeDynamicLoading1.errorMessage,10).isDisplayed());
